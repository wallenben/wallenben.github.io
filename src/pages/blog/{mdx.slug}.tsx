...
const MDXPage = ({ data }) => {
  return (
    <Layout>
      <main className="max-w-4xl flex-grow  mx-auto flex flex-col justify-around bg-white dark:bg-gray-700 text-green-600 dark:text-green-300 rounded-xl p-6 m-3">

      ...
      <main className="max-w-4xl flex-grow mx-auto flex flex-col justify-around">
        <div className="sm:flex sm:flex-row-reverse sm:items-center">
          <div className="sm:px-2">
            ...
            Examples of my work can be found on <a className="text-green-500 dark:text-green-200" href="https://twitter.com/gatsbyjs">github</a>. More prominent projects will be featured here! </p> 
          </div>
